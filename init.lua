...
-- =========================== Open and close the terminal using leader enter =====================================================
...
-- leader a to replace all
vim.keymap.set('n', '<leader>a', ':%s/\\<<C-r><C-w>\\>//g<left><left>', { desc = 'Replace all' })

-- =========================== END   map leader enter to open and close the terminal ====================
--
--
--
--
...
-- map F to open diagnostic float with vim.diagnostics.open_float()
...
require('lazy').setup({
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          -- Show error messages from the LSP server with leader e
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ensure_installed = { 'bash', 'java', 'javascript', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc' },
